...
finds outlet location given link numbers on either side of a catchment
boundary
...
given a subset of links in demnet, compute the catchment boundary and
its in/outlets
...
merge catchments according to a minimum area rule, given the output of
my\_find\_catchments
...
delineate a set of mutually exclusive catchment polygons based on
suggested outlet points
