...
**rswat\_output**: R functions for executing SWAT+ simulations and
...
is an R core package that adds support for parallel computing

``` r
library(parallel)
```

[`DEOptimR`](https://cran.r-project.org/web/packages/DEoptimR) is an
implementation of differential evolution algorithms for nonlinear
...
parallel implementation of adaptive differential evolution algorithm
from the DEoptimR package
...
create a cluster of nodes for running SWAT+ simulations (possibly in
parallel)
