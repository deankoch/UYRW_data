...
variable at each observation point in space. These locations are called
“weather stations”, although they need not come from actual gages. We
will use data gridded climatic reconstruction models to train the SWAT
model. This function converts the gridded data to input txt files that
can be read by SWAT2012.
