...
#' 
#' Construction of a SWAT+ model usually starts in QGIS3, where georeferenced data are assembled
#' and processed by the QSWAT+ plugin to generate a set of shapefiles and tables that can be
#' interpreted by SWAT+Editor. The latter then creates the SWAT+ text input/output directory
#' and populates it with configuration files needed by the simulation executable.
#' 
...
#' ## dependencies
#' 
#' There should be no dependencies beyond the libraries listed above, however note that these
