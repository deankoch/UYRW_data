...
#' and generate SWAT+ AW input files "usersoil.csv", "soil.csv", and "soil.tif"
#' 
...
#' [`dplyr`](https://cran.r-project.org/web/packages/dplyr/index.html) is used for manipulating the tabular data,
