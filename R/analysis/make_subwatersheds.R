...
files.towrite = list(
  ...
  # graphic showing one of the intermediate steps in TauDEM for catchment delineation
  c(name='img_taudem',
    file=file.path(graphics.dir, 'my_upslope_areas.png'),
    type='png graphic', 
    description='image of contributing area upstream of each cell (ssa from TauDEM)'),
...
#' 
#' Read about drop analysis [here](https://hydrology.usu.edu/taudem/taudem5/help53/StreamDropAnalysis.html)
#+ eval=FALSE
