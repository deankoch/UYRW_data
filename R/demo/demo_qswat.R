...
#' The shapefiles are mostly for visualization, but they are also useful for matching up locations to
...
#' 
#' It is useful to make a backup of this directory before changing anything, so we zip a copy now
